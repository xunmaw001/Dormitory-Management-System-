  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='suguan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.suguanxingming" class="input" type="text" placeholder="宿管姓名">
			   </div>
			 </div> -->
			<el-form-item label="宿管姓名" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.suguanxingming" autocomplete="off" placeholder="宿管姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='suguan'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='suguan'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='suguan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gonghao) && `suguan` == this.tableName){
      ...
      if(`suguan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`suguan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      if(`suguan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
