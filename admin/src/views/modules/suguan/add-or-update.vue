    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="楼号" prop="louhao">
          <el-select :disabled="ro.louhao" @change="louhaoChange" v-model="ruleForm.louhao" placeholder="请选择楼号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.louhao" label="楼号" prop="louhao">
