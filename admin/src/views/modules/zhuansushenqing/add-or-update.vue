<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="楼号" prop="louhao">
          <el-select :disabled="ro.louhao" v-model="ruleForm.louhao" placeholder="请选择楼号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="床位号" prop="chuangweihao">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="转宿申请时间" prop="zhuansushenqingshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhuansushenqingshijian" 
                type="datetime"
                :readonly="ro.zhuansushenqingshijian"
                placeholder="转宿申请时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuansushenqingshijian" label="转宿申请时间" prop="zhuansushenqingshijian">
              <el-input v-model="ruleForm.zhuansushenqingshijian" 
                placeholder="转宿申请时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zhuansushenqingshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chuangweihao = true;
          ...
          if(o=='zhuansushenqingshijian'){
            this.ruleForm.zhuansushenqingshijian = obj[o];
	    this.ro.zhuansushenqingshijian = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhuansushenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhuansushenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
