<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="申请退宿时间" prop="shenqingtuisushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shenqingtuisushijian" 
                type="datetime"
                :readonly="ro.shenqingtuisushijian"
                placeholder="申请退宿时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenqingtuisushijian" label="申请退宿时间" prop="shenqingtuisushijian">
              <el-input v-model="ruleForm.shenqingtuisushijian" 
                placeholder="申请退宿时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.shenqingtuisushijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chuangweihao = true;
          ...
          if(o=='shenqingtuisushijian'){
            this.ruleForm.shenqingtuisushijian = obj[o];
	    this.ro.shenqingtuisushijian = true;
            continue;
          }
        }
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.renshu = parseFloat(objcross.renshu) + parseFloat(this.ruleForm.renshu)
                }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuisushenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuisushenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
