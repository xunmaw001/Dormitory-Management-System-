<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="公告时间" prop="gonggaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.gonggaoshijian" 
                type="datetime"
                :readonly="ro.gonggaoshijian"
                placeholder="公告时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gonggaoshijian" label="公告时间" prop="gonggaoshijian">
              <el-input v-model="ruleForm.gonggaoshijian" 
                placeholder="公告时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.gonggaoshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonggaoneirong = true;
          ...
          if(o=='gonggaoshijian'){
            this.ruleForm.gonggaoshijian = obj[o];
	    this.ro.gonggaoshijian = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../phpc0l92/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `sushegonggao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.sushegonggaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
